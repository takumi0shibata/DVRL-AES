"""Training on DVRL
Features_modelを利用して作成した擬似ラベルを報酬計算に利用する手法
"""
...
def main(args):
    ...
    if args.wandb:
        wandb.init(
            project=args.pjname,
            name=args.run_name + f'_{args.pred_model}_{target_prompt_id}_seed{args.seed}_dev{args.dev_size}_lambda{args.loss_lambda}',
