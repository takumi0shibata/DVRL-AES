...
def train_and_evaluate(
    ...
    tr_s_loader = DataLoader(PMAESDataSet(**source), batch_size=s_batch_size)
    if args.dev_size > 0:
        va_s_loader = DataLoader(PMAESDataSet(**dev), batch_size=s_batch_size)
    pd_t_loader = DataLoader(PMAESDataSet(**pseudo), batch_size=s_batch_size)
    te_t_loader = DataLoader(PMAESDataSet(**target), batch_size=t_batch_size)
